...
void usart_mute_rxneie(uint8_t usart)
{
    set_reg(r_CORTEX_M_USART_CR1(usart), 0, USART_CR1_RXNEIE);
}

void usart_unmute_rxneie(uint8_t usart)
{
    set_reg(r_CORTEX_M_USART_CR1(usart), 1, USART_CR1_RXNEIE);
}
